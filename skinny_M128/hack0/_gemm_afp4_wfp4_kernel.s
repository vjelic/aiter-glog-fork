...
.LBB0_0:
	...
	v_or_b32_e32 v3, 32, v43
	v_or_b32_e32 v36, s13, v3
	...
	v_or_b32_e32 v40, s13, v6
	v_cndmask_b32_e32 v10, v10, v11, vcc
	v_subrev_u32_e32 v11, s15, v10
	v_cmp_le_u32_e32 vcc, s15, v10
	v_or_b32_e32 v8, s13, v42
	v_add_u32_e32 v8, s1, v8
	v_cndmask_b32_e32 v10, v10, v11, vcc
	v_add_u32_e32 v11, s1, v34
	...
	v_lshl_or_b32 v47, v13, 13, v15
	v_lshl_or_b32 v51, v6, 13, v15
	...
	s_mov_b32 s16, s2
	v_cndmask_b32_e32 v2, v3, v64, vcc
	s_mov_b32 m0, s0
	v_lshl_add_u32 v65, v10, 13, v15
	v_readfirstlane_b32 s0, v7
	v_add_u32_e32 v13, 0x6000, v6
	buffer_load_dwordx4 v2, s[16:19], 0 offen lds
	v_cndmask_b32_e32 v2, v3, v65, vcc
	s_mov_b32 m0, s0
	v_lshl_add_u32 v66, v11, 13, v15
	v_readfirstlane_b32 s0, v8
	buffer_load_dwordx4 v2, s[16:19], 0 offen lds
	v_cndmask_b32_e32 v2, v3, v66, vcc
	s_mov_b32 m0, s0
	v_lshl_add_u32 v67, v12, 13, v15
	v_readfirstlane_b32 s0, v13
	buffer_load_dwordx4 v2, s[16:19], 0 offen lds
	v_cndmask_b32_e32 v2, v3, v67, vcc
	s_mov_b32 m0, s0
	s_add_i32 s22, 0, 0x10000
	buffer_load_dwordx4 v2, s[16:19], 0 offen lds
	v_add_u32_e32 v2, s22, v60
	v_add_u32_e32 v6, 0x2000, v2
	v_add_u32_e32 v9, v47, v16
	...
	v_add_u32_e32 v2, v50, v16
	v_cndmask_b32_e32 v2, v3, v2, vcc
	s_mov_b32 m0, s0
	v_readfirstlane_b32 s0, v8
	buffer_load_dwordx4 v2, s[16:19], 0 offen sc0 nt lds
	v_add_u32_e32 v2, v51, v16
	v_cndmask_b32_e32 v2, v3, v2, vcc
	s_mov_b32 m0, s0
	...
	v_bitop3_b32 v61, v6, v3, v5 bitop3:0x36
	v_or_b32_e32 v2, 0xc0, v2
	v_and_b32_e32 v3, 0xc0, v14
	s_addc_u32 s25, s5, 0
	v_or_b32_e32 v4, v10, v4
	v_and_or_b32 v7, v42, 48, v7
	v_or3_b32 v10, v10, v45, v44
	v_bitop3_b32 v62, v3, v2, v5 bitop3:0x36
	...
	v_lshlrev_b32_e32 v69, 4, v7
	v_lshlrev_b32_e32 v68, 4, v10
	v_bitop3_b32 v63, v8, v5, v6 bitop3:0x36
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add3_u32 v73, s22, v58, v59
	v_add_u32_e32 v79, s22, v60
	...
	v_add_u32_e32 v95, v73, v70
	ds_read_u8 v106, v97
	ds_read_u8 v107, v95
	v_add_u32_e32 v89, v86, v48
	s_waitcnt lgkmcnt(3)
	...
	v_add_u32_e32 v83, v92, v57
	v_add_u32_e32 v92, v92, v56
	v_add_u32_e32 v99, v93, v57
	s_waitcnt lgkmcnt(2)
...
; %bb.2:
	v_add_u32_e32 v47, s21, v72
	v_add_u32_e32 v49, v47, v71
	v_add_u32_e32 v50, v47, v70
	s_waitcnt vmcnt(0)
	s_barrier
	ds_read_u8 v54, v49
	ds_read_u8 v96, v49 offset:4
	ds_read_u8 v97, v49 offset:8
	ds_read_u8 v49, v49 offset:12
	ds_read_u8 v100, v50
	ds_read_u8 v101, v50 offset:4
	ds_read_u8 v102, v50 offset:8
	ds_read_u8 v103, v50 offset:12
	v_add_u32_e32 v50, s15, v72
	v_add_u32_e32 v51, v50, v69
	v_add_u32_e32 v50, v50, v68
	v_add_u32_e32 v112, s23, v35
	v_add_u32_e32 v113, s23, v63
	ds_read_u8 v104, v51
	ds_read_u8 v105, v51 offset:4
	ds_read_u8 v106, v51 offset:8
	ds_read_u8 v107, v51 offset:12
	ds_read_u8 v108, v50
	ds_read_u8 v109, v50 offset:4
	ds_read_u8 v110, v50 offset:8
	ds_read_u8 v111, v50 offset:12
	v_add_u32_e32 v50, v112, v55
	v_add_u32_e32 v58, v113, v55
	v_add_u32_e32 v35, s22, v35
	ds_read_b128 v[50:53], v50
	ds_read_b128 v[64:67], v58
	v_add_u32_e32 v58, v35, v57
	...
	v_add_u32_e32 v80, v114, v55
	ds_read_b128 v[72:75], v58
	v_add_u32_e32 v58, v98, v57
	...
	s_waitcnt lgkmcnt(7)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[2:5], v[68:71], v[50:53], v[2:5], v104, v54 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_ashr_i32 s0, s13, 31
	s_ashr_i32 s21, s20, 31
	s_movk_i32 s10, 0x78c
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[18:21], v[88:91], v[50:53], v[18:21], v108, v54 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[50:53], v35
	v_add_u32_e32 v35, v62, v56
	ds_read_b128 v[54:57], v35
	v_add_u32_e32 v35, v112, v48
	v_mfma_scale_f32_16x16x128_f8f6f4 v[2:5], v[72:75], v[64:67], v[2:5], v105, v96 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_lshlrev_b32_e32 v1, 3, v1
	v_mul_u32_u24_e32 v43, 0x1a000, v43
	s_mov_b32 s11, 0x27000
	s_waitcnt lgkmcnt(2)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[18:21], v[92:95], v[64:67], v[18:21], v109, v96 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[62:65], v35
	v_add_u32_e32 v35, v113, v48
	v_mfma_scale_f32_16x16x128_f8f6f4 v[2:5], v[58:61], v[80:83], v[2:5], v106, v97 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(2)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[18:21], v[50:53], v[80:83], v[18:21], v110, v97 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[80:83], v35
	v_add_u32_e32 v35, v114, v48
	s_waitcnt lgkmcnt(1)
	...
	v_add_u32_e32 v62, v113, v39
	v_mfma_scale_f32_16x16x128_f8f6f4 v[2:5], v[76:79], v[84:87], v[2:5], v107, v49 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[18:21], v[54:57], v[84:87], v[18:21], v111, v49 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[84:87], v35
	v_add_u32_e32 v35, v115, v48
	...
	v_add_u32_e32 v80, v114, v39
	v_add_u32_e32 v39, v115, v39
	s_waitcnt lgkmcnt(2)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[14:17], v[58:61], v[84:87], v[14:17], v106, v102 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[10:13], v[50:53], v[84:87], v[10:13], v110, v102 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[14:17], v[76:79], v[96:99], v[14:17], v107, v103 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[10:13], v[54:57], v[96:99], v[10:13], v111, v103 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_u8 v66, v35
	ds_read_u8 v67, v35 offset:4
	ds_read_u8 v96, v35 offset:8
	ds_read_u8 v35, v35 offset:12
	ds_read_u8 v97, v41
	ds_read_u8 v98, v41 offset:4
	ds_read_u8 v99, v41 offset:8
	ds_read_u8 v41, v41 offset:12
	ds_read_b128 v[62:65], v62
	ds_read_b128 v[84:87], v39
	s_waitcnt lgkmcnt(9)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[6:9], v[68:71], v[46:49], v[6:9], v104, v66 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[80:83], v80
	v_add_u32_e32 v39, v112, v37
	v_cvt_pk_bf16_f32 v13, v12, v13
	v_mfma_scale_f32_16x16x128_f8f6f4 v[22:25], v[88:91], v[46:49], v[22:25], v108, v66 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[46:49], v39
	v_cvt_pk_bf16_f32 v12, v10, v11
	s_waitcnt lgkmcnt(3)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[6:9], v[72:75], v[62:65], v[6:9], v105, v67 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[22:25], v[92:95], v[62:65], v[22:25], v109, v67 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[6:9], v[58:61], v[80:83], v[6:9], v106, v96 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[22:25], v[50:53], v[80:83], v[22:25], v110, v96 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[6:9], v[76:79], v[84:87], v[6:9], v107, v35 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[22:25], v[54:57], v[84:87], v[22:25], v111, v35 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v35, v113, v37
	ds_read_b128 v[62:65], v35
	v_add_u32_e32 v35, v114, v37
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[30:33], v[68:71], v[46:49], v[30:33], v104, v97 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[66:69], v35
	v_add_u32_e32 v35, v115, v37
	v_mov_b32_e32 v39, s0
	v_mfma_scale_f32_16x16x128_f8f6f4 v[26:29], v[88:91], v[46:49], v[26:29], v108, v97 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[30:33], v[58:61], v[66:69], v[30:33], v106, v99 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_barrier
	v_and_b32_e32 v49, 0x78, v48
	v_mfma_scale_f32_16x16x128_f8f6f4 v[26:29], v[50:53], v[66:69], v[26:29], v110, v99 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_or_b32_e32 v46, s20, v49
	v_mov_b32_e32 v47, s21
	v_or_b32_e32 v43, v43, v49
	v_mfma_scale_f32_16x16x128_f8f6f4 v[30:33], v[76:79], v[70:73], v[30:33], v107, v41 op_sel_hi:[0,0,0] cbsz:4 blgp:4
