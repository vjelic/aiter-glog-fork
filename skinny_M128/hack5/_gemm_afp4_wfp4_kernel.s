...
.LBB0_0:
	...
	v_lshl_or_b32 v52, v8, 9, v5
	v_lshl_or_b32 v53, v9, 9, v5
	v_add_u32_e32 v5, s15, v54
	s_movk_i32 s0, 0xf0
	v_readfirstlane_b32 s1, v5
	v_add_u32_e32 v5, s22, v54
	s_mov_b32 m0, s1
	v_readfirstlane_b32 s1, v5
	v_and_b32_e32 v5, 48, v0
	v_lshl_or_b32 v51, v7, 13, v15
	...
	buffer_load_dword v52, s[16:19], 0 offen lds
...
.LBB0_2:
	...
	v_and_or_b32 v2, v42, 48, v8
	v_or3_b32 v3, v11, v45, v44
...
.LBB0_3:                                ; =>This Inner Loop Header: Depth=1
	...
	s_add_i32 s22, s15, 0
	s_add_i32 s15, s22, 0x20000
	v_add_u32_e32 v73, s15, v54
	s_and_b32 s17, s3, 0xffff
	v_readfirstlane_b32 s3, v73
	s_mov_b32 m0, s3
	s_lshl_b32 s3, s28, 15
	s_add_i32 s21, s3, 0
	v_add_u32_e32 v73, s21, v59
	...
	v_add_u32_e32 v123, s2, v63
	v_add_u32_e32 v130, s2, v61
	v_add_u32_e32 v131, s2, v62
	v_add_u32_e32 v74, v122, v55
	v_add_u32_e32 v78, v123, v55
	v_add_u32_e32 v82, v130, v55
	v_add_u32_e32 v86, v131, v55
	v_add_u32_e32 v90, v122, v50
	v_add_u32_e32 v94, v123, v50
	v_add_u32_e32 v98, v130, v50
	v_add_u32_e32 v102, v131, v50
	...
	s_waitcnt lgkmcnt(0)
	; sched_barrier mask(0x00000000)
	s_add_i32 s22, s22, 0x21000
	v_add_u32_e32 v138, s22, v54
	s_and_b32 s1, s23, 0xffff
	s_add_i32 s23, s21, 0x10000
	v_readfirstlane_b32 s16, v138
	v_add3_u32 v138, s23, v57, v58
	v_add_u32_e32 v139, s23, v59
	v_sub_u32_e32 v143, v138, v139
	v_ashrrev_i32_e32 v144, 31, v143
	v_lshrrev_b32_e32 v144, 28, v144
	s_mov_b32 s2, s18
	s_mov_b32 s3, s19
	s_mov_b32 m0, s16
	v_add_u32_e32 v140, 0x2000, v139
	v_add_u32_e32 v143, v143, v144
	buffer_load_dword v53, s[0:3], 0 offen lds
	v_add_u32_e32 v141, 0x4000, v139
	v_add_u32_e32 v142, 0x6000, v139
	v_and_b32_e32 v143, -16, v143
	v_readfirstlane_b32 s0, v139
	v_sub_u32_e32 v139, v138, v140
	s_and_b32 s17, s25, 0xffff
	s_mov_b32 s16, s24
	v_add_u32_e32 v143, v143, v47
	s_mov_b32 m0, s0
	v_add_u32_e32 v139, 0x2000, v139
	buffer_load_dwordx4 v143, s[16:19], 0 offen sc0 nt lds
	v_ashrrev_i32_e32 v143, 31, v139
	v_lshrrev_b32_e32 v143, 28, v143
	v_add_u32_e32 v139, v139, v143
	v_and_b32_e32 v139, -16, v139
	v_readfirstlane_b32 s0, v140
	v_add_u32_e32 v139, v139, v48
	s_mov_b32 m0, s0
	v_readfirstlane_b32 s0, v141
	buffer_load_dwordx4 v139, s[16:19], 0 offen sc0 nt lds
	v_sub_u32_e32 v139, v138, v141
	v_add_u32_e32 v139, 0x4000, v139
	v_ashrrev_i32_e32 v140, 31, v139
	v_lshrrev_b32_e32 v140, 28, v140
	v_add_u32_e32 v139, v139, v140
	v_and_b32_e32 v139, -16, v139
	v_sub_u32_e32 v138, v138, v142
	v_add_u32_e32 v139, v139, v49
	s_mov_b32 m0, s0
	v_add_u32_e32 v138, 0x6000, v138
	buffer_load_dwordx4 v139, s[16:19], 0 offen sc0 nt lds
	v_ashrrev_i32_e32 v139, 31, v138
	v_lshrrev_b32_e32 v139, 28, v139
	v_add_u32_e32 v138, v138, v139
	v_and_b32_e32 v138, -16, v138
	v_readfirstlane_b32 s0, v142
	v_add_u32_e32 v138, v138, v51
	s_mov_b32 m0, s0
	s_nop 0
	buffer_load_dwordx4 v138, s[16:19], 0 offen sc0 nt lds
	; sched_barrier mask(0x00000000)
	v_add_u32_e32 v138, s30, v68
	v_add_u32_e32 v139, v138, v70
	s_barrier
	v_add_u32_e32 v138, v138, v69
	ds_read_u8 v185, v139
	ds_read_u8 v186, v139 offset:4
	ds_read_u8 v187, v139 offset:8
	ds_read_u8 v188, v139 offset:12
	ds_read_u8 v189, v138
	ds_read_u8 v190, v138 offset:4
	ds_read_u8 v191, v138 offset:8
	ds_read_u8 v192, v138 offset:12
	v_add_u32_e32 v154, s29, v35
	v_add_u32_e32 v155, s29, v63
	v_add_u32_e32 v162, s29, v61
	v_add_u32_e32 v163, s29, v62
...
.LBB0_6:
	...
	v_add_u32_e32 v47, s15, v68
	v_add_u32_e32 v48, v47, v72
	v_add_u32_e32 v49, v47, v71
	s_waitcnt vmcnt(0)
	s_barrier
	ds_read_u8 v51, v48
	ds_read_u8 v57, v48 offset:4
	ds_read_u8 v96, v48 offset:8
	ds_read_u8 v48, v48 offset:12
	ds_read_u8 v100, v49
	ds_read_u8 v101, v49 offset:4
	ds_read_u8 v102, v49 offset:8
	ds_read_u8 v103, v49 offset:12
	v_add_u32_e32 v49, s22, v68
	v_add_u32_e32 v52, v49, v70
	v_add_u32_e32 v49, v49, v69
	v_add_u32_e32 v112, s21, v35
	v_add_u32_e32 v113, s21, v63
	ds_read_u8 v104, v52
	ds_read_u8 v105, v52 offset:4
	ds_read_u8 v106, v52 offset:8
	ds_read_u8 v107, v52 offset:12
	ds_read_u8 v108, v49
	ds_read_u8 v109, v49 offset:4
	ds_read_u8 v110, v49 offset:8
	ds_read_u8 v111, v49 offset:12
	v_add_u32_e32 v49, v112, v55
	v_add_u32_e32 v52, v113, v55
	v_add_u32_e32 v35, s23, v35
	ds_read_b128 v[64:67], v49
	ds_read_b128 v[68:71], v52
	v_add_u32_e32 v52, v35, v60
	v_add_u32_e32 v63, s23, v63
	ds_read_b128 v[72:75], v52
	v_add_u32_e32 v52, v63, v60
	v_add_u32_e32 v97, s23, v61
	v_add_u32_e32 v114, s21, v61
	ds_read_b128 v[76:79], v52
	v_add_u32_e32 v52, v97, v60
	v_add_u32_e32 v98, s23, v62
	v_add_u32_e32 v49, v114, v55
	v_add_u32_e32 v115, s21, v62
	ds_read_b128 v[80:83], v52
	v_add_u32_e32 v52, v98, v60
	ds_read_b128 v[58:61], v52
	ds_read_b128 v[84:87], v49
	v_add_u32_e32 v49, v115, v55
	...
	v_add_u32_e32 v35, v97, v56
	s_waitcnt lgkmcnt(7)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[30:33], v[72:75], v[64:67], v[30:33], v104, v51 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_ashr_i32 s0, s13, 31
	s_ashr_i32 s21, s20, 31
	s_movk_i32 s10, 0x78c
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[22:25], v[88:91], v[64:67], v[22:25], v108, v51 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[62:65], v35
	v_add_u32_e32 v35, v98, v56
	v_lshlrev_b32_e32 v1, 3, v1
	v_mfma_scale_f32_16x16x128_f8f6f4 v[30:33], v[76:79], v[68:71], v[30:33], v105, v57 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mul_u32_u24_e32 v43, 0x1a000, v43
	s_mov_b32 s11, 0x27000
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[22:25], v[92:95], v[68:71], v[22:25], v109, v57 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[66:69], v35
	v_add_u32_e32 v35, v112, v50
	v_add_u32_e32 v57, v114, v39
	v_mfma_scale_f32_16x16x128_f8f6f4 v[30:33], v[80:83], v[84:87], v[30:33], v106, v96 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[22:25], v[62:65], v[84:87], v[22:25], v110, v96 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[30:33], v[58:61], v[52:55], v[30:33], v107, v48 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[22:25], v[66:69], v[52:55], v[22:25], v111, v48 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[52:55], v35
	v_add_u32_e32 v35, v113, v50
	ds_read_b128 v[84:87], v35
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[26:29], v[72:75], v[52:55], v[26:29], v104, v100 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v35, v114, v50
	ds_read_b128 v[96:99], v35
	v_add_u32_e32 v35, v115, v50
	v_mfma_scale_f32_16x16x128_f8f6f4 v[18:21], v[88:91], v[52:55], v[18:21], v108, v100 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[48:51], v35
	v_add_u32_e32 v35, v47, v41
	v_add_u32_e32 v41, v47, v46
	s_waitcnt lgkmcnt(2)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[26:29], v[76:79], v[84:87], v[26:29], v105, v101 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v46, v112, v39
	ds_read_b128 v[52:55], v46
	v_add_u32_e32 v46, v113, v39
	v_mfma_scale_f32_16x16x128_f8f6f4 v[18:21], v[92:95], v[84:87], v[18:21], v109, v101 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v39, v115, v39
	v_cvt_pk_bf16_f32 v25, v24, v25
	v_cvt_pk_bf16_f32 v24, v22, v23
	s_waitcnt lgkmcnt(2)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[26:29], v[80:83], v[96:99], v[26:29], v106, v102 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[18:21], v[62:65], v[96:99], v[18:21], v110, v102 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[26:29], v[58:61], v[48:51], v[26:29], v107, v103 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[18:21], v[66:69], v[48:51], v[18:21], v111, v103 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_u8 v50, v35
	ds_read_u8 v51, v35 offset:4
	ds_read_u8 v56, v35 offset:8
	ds_read_u8 v35, v35 offset:12
	ds_read_u8 v100, v41
	ds_read_u8 v101, v41 offset:4
	ds_read_u8 v102, v41 offset:8
	ds_read_u8 v41, v41 offset:12
	ds_read_b128 v[46:49], v46
	ds_read_b128 v[96:99], v39
	s_waitcnt lgkmcnt(9)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[14:17], v[72:75], v[52:55], v[14:17], v104, v50 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[84:87], v57
	v_add_u32_e32 v39, v112, v37
	v_cvt_pk_bf16_f32 v21, v20, v21
	v_mfma_scale_f32_16x16x128_f8f6f4 v[6:9], v[88:91], v[52:55], v[6:9], v108, v50 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_cvt_pk_bf16_f32 v20, v18, v19
	s_waitcnt lgkmcnt(2)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[14:17], v[76:79], v[46:49], v[14:17], v105, v51 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[6:9], v[92:95], v[46:49], v[6:9], v109, v51 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[46:49], v39
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[14:17], v[80:83], v[84:87], v[14:17], v106, v56 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[6:9], v[62:65], v[84:87], v[6:9], v110, v56 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[14:17], v[58:61], v[96:99], v[14:17], v107, v35 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[6:9], v[66:69], v[96:99], v[6:9], v111, v35 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v35, v113, v37
	ds_read_b128 v[50:53], v35
	v_add_u32_e32 v35, v114, v37
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[2:5], v[72:75], v[46:49], v[2:5], v104, v100 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[54:57], v35
	v_add_u32_e32 v35, v115, v37
	ds_read_b128 v[70:73], v35
	v_mfma_scale_f32_16x16x128_f8f6f4 v[10:13], v[88:91], v[46:49], v[10:13], v108, v100 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mov_b32_e32 v39, s0
	v_mov_b32_e32 v37, s0
	v_mov_b32_e32 v35, s0
	s_waitcnt lgkmcnt(2)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[2:5], v[76:79], v[50:53], v[2:5], v105, v101 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_lshlrev_b32_e32 v48, 3, v0
	v_lshl_or_b32 v0, v0, 7, v42
	v_and_or_b32 v0, v0, s10, v45
	v_mfma_scale_f32_16x16x128_f8f6f4 v[10:13], v[92:95], v[50:53], v[10:13], v109, v101 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_or3_b32 v0, v0, v44, v1
	s_movk_i32 s10, 0x7f8
	s_waitcnt lgkmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[2:5], v[80:83], v[54:57], v[2:5], v106, v102 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_barrier
	v_and_b32_e32 v49, 0x78, v48
	v_mfma_scale_f32_16x16x128_f8f6f4 v[10:13], v[62:65], v[54:57], v[10:13], v110, v102 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 v[10:13], v[66:69], v[70:73], v[10:13], v111, v41 op_sel_hi:[0,0,0] cbsz:4 blgp:4
