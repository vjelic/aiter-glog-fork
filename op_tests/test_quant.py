...
@benchmark()
def test_quant(m, n, dtype=dtypes.bf16):
    dim = (m, n)
    ...
    checkAllclose(a.to(dtypes.fp32), b.to(dtypes.fp32), rtol=0.125, atol=1e-3, msg=msg)
    ...
    checkAllclose(a.to(dtypes.fp32), c.to(dtypes.fp32), rtol=0.125, atol=1e-3, msg=msg)
    ...
    # checkAllclose(a.to(dtypes.fp32), d.to(dtypes.fp32), rtol=0.125, atol=1e-3, msg=msg)
