...
def get_x_vals():
    ...
    N_K_range = [(18432, 16384), (16384, 16384), (106496, 16384), (16384, 53248)]
    M_range = [
        1,
        4,
        8,
    ...
    # N_range = [16384, 16384, 18432]
    # K_range = [6656, 8192, 16384, 53248]
    space = itertools.product(N_K_range, M_range)
    x_vals = []
