...
class TestGemmA8WFP4:
    ...
    basic_set = [
        ...
        for layout in ["TN"] #TODO Kernel will occasionally crash for layouts other than TN.
    ]
    ...
    @pytest.mark.parametrize("M, N, K, a_dtype, out_dtype, layout", test_params)
    ...
    def test_gemm_a8wfp4(
        self, M: int, N: int, K: int, a_dtype, out_dtype, layout: str, CLEAR_GPUS=True
    ):
