...
def fp8_assert_close(
    ...
    max_abs_pos = np.unravel_index(max_abs_idx, tensor_a.shape)
    max_rel_pos = np.unravel_index(max_rel_idx, tensor_a.shape)
...
def test_mha_fused_backward(
    ...
    triton_out, _, sd_mask = triton_out[0], triton_out[1], triton_out[2]
