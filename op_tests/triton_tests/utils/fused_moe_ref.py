import torch
from op_benchmarks.triton.utils.quantization import quantize_fp8


def torch_moe(a, b, c, a_scale, b_scale, b_zp, group_size, topk_ids,
              topk_weights, routed_weight, sorted_token_ids, expert_ids,
              num_tokens_post_padded, dtype, fp8_w8a8, int8_w8a16, int4_w4a16,
              gelu=False):
    if fp8_w8a8:
