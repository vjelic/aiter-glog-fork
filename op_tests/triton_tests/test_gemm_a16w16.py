...
class TestGEMMA16W16:
    ...
    def test_gemm_a16_w16(self, M: int, N: int, K: int, dtype_str, output):
        x, w, out_dtype, y = Test_gemm_a16w16.generate_gemm_a16w16_inputs(M, N, K, str_to_torch_dtype[dtype_str], output=output)
    ...
    def test_gemm_a16_w16_atomic(self, M: int, N: int, K: int, dtype_str, output):
        ...
        x, w, out_dtype, y = Test_gemm_a16w16.generate_gemm_a16w16_inputs(M, N, K, dtype, output=output)
