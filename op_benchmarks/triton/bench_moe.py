...
def run_benchmark(args):
    ...
    assert input_dtype != "int4_w4a16" or group_size is not None, \
    ...
    def bench_moe_gemm(M, N, K, E, top_k, metric, input_dtype, aux_dtype, model=None):
        ...
        fn = lambda: triton_moe(  # noqa: E731
            a, b, triton_out, a_scale, b_scale, b_zp,
            topk_weights, topk_ids, sorted_token_ids, expert_ids, num_tokens_post_padded, routed_weight,
            top_k, config, torch_to_tl_dtype[aux_dtype], fp8_w8a8, int8_w8a16, use_int4_w4a16=False
        )
...
def parse_args():
    ...
    parser.add_argument("--group-size", type=int, default=None, help="group_size for int4")
    parser.add_argument("--routed-weight", action='store_true')
    parser.add_argument("--input-dtype", type=str, choices=["int8_w8a16", "fp8_w8a8", "int4_w4a16", None], default=None)
