...
import torch
import triton
from aiter.ops.triton.gemm_a8w8_blockscale_splitk import gemm_a8w8_blockscale_splitk
...
def run_benchmark(args):
    ...
    def bench_gemm_a8w8_blockscale(M, N, K, metric, provider):
        ...
        ms = triton.testing.do_bench(
            lambda: gemm_a8w8_blockscale_splitk(x, weight, x_scale, w_scale, c_dtype),
            warmup=25, rep=100)
