...
.LBB0_0:
	...
	s_lshl_b32 s30, s15, 16
	v_cmp_eq_u32_e32 vcc, 1, v2
	v_readfirstlane_b32 s15, v1
	s_or_b32 s17, s16, s30
	s_mov_b32 s16, s2
	s_waitcnt lgkmcnt(1)
	...
	buffer_load_dwordx4 v1, s[16:19], 0 offen lds
	s_add_i32 s15, 0, 0x10000
	s_and_b32 s16, s20, 0x3fff
	v_add_u32_e32 v1, s15, v141
	s_bitset1_b32 s16, 14
...
; %bb.1:                                ; %.lr.ph
	v_or_b32_e32 v4, v166, v162
	v_or_b32_e32 v5, 0x80, v154
	v_or_b32_e32 v6, v5, v162
	v_or_b32_e32 v7, 0xc0, v154
	...
	v_or_b32_e32 v10, v131, v8
	v_and_or_b32 v4, v4, s1, v12
	v_bitop3_b32 v152, v14, v131, v149 bitop3:0x36
	v_bitop3_b32 v167, v14, v11, v149 bitop3:0x36
	v_or_b32_e32 v14, v4, v13
	v_bitop3_b32 v176, v4, v10, v13 bitop3:0x36
	...
	v_or_b32_e32 v10, v131, v5
	v_and_or_b32 v4, v4, s1, v12
	v_bitop3_b32 v153, v15, v131, v149 bitop3:0x36
	v_bitop3_b32 v168, v15, v11, v149 bitop3:0x36
	v_or_b32_e32 v15, v4, v13
	v_bitop3_b32 v177, v4, v10, v13 bitop3:0x36
	v_lshlrev_b32_e32 v4, 7, v7
	s_add_u32 s4, s4, 0x80
	v_and_b32_e32 v7, 0x80, v4
	s_movk_i32 s1, 0x7800
	s_addc_u32 s5, s5, 0
	v_or_b32_e32 v10, v131, v7
	v_and_or_b32 v4, v4, s1, v12
	...
	v_bitop3_b32 v178, v4, v10, v13 bitop3:0x36
	v_or_b32_e32 v4, v11, v6
	s_addc_u32 s3, s3, 0
	v_bitop3_b32 v179, v9, v4, v149 bitop3:0x36
	v_or_b32_e32 v4, v11, v8
	s_add_u32 s10, s10, s23
	v_bitop3_b32 v180, v14, v4, v149 bitop3:0x36
	v_or_b32_e32 v4, v11, v5
	s_addc_u32 s11, s11, s33
	v_bitop3_b32 v181, v15, v4, v149 bitop3:0x36
	v_or_b32_e32 v4, v11, v7
	v_add_u32_e32 v2, v154, v2
	s_add_u32 s8, s8, s22
	v_mov_b32_e32 v122, 0
	v_or_b32_e32 v145, v1, v3
	...
	v_bitop3_b32 v170, v16, v11, v149 bitop3:0x36
	v_bitop3_b32 v172, v17, v11, v149 bitop3:0x36
	v_bitop3_b32 v174, v18, v11, v149 bitop3:0x36
	v_bitop3_b32 v182, v12, v4, v149 bitop3:0x36
	v_or_b32_e32 v183, v165, v3
...
.LBB0_2:                                ; =>This Inner Loop Header: Depth=1
	...
	s_mov_b32 m0, s42
	s_and_b32 s38, s9, 0xffff
	v_readfirstlane_b32 s44, v189
	buffer_load_dwordx4 v187, s[16:19], 0 offen lds
	s_mov_b32 m0, s43
	s_mov_b32 s40, s27
	buffer_load_dwordx4 v188, s[16:19], 0 offen lds
	s_or_b32 s17, s38, s28
	s_mov_b32 s16, s8
	s_mov_b32 m0, s44
	s_mov_b32 s38, s15
	buffer_load_dword v146, s[16:19], 0 offen lds
	; sched_barrier mask(0x00000000)
	s_add_i32 s27, s39, 0x21000
	v_add_u32_e32 v185, s27, v133
	s_and_b32 s15, s11, 0xffff
	s_or_b32 s17, s15, s29
	v_readfirstlane_b32 s15, v185
	s_mov_b32 s16, s10
	s_mov_b32 m0, s15
	s_nop 0
	...
	; sched_barrier mask(0x00000000)
	; sched_barrier mask(0x00000000)
	s_add_i32 s15, s1, 0x10000
	v_add3_u32 v185, s15, v135, v137
	v_add_u32_e32 v186, s15, v141
	...
	s_mov_b32 s16, s4
	s_mov_b32 m0, s39
	v_readfirstlane_b32 s39, v187
	s_waitcnt lgkmcnt(1)
	buffer_load_dwordx4 v190, s[16:19], 0 offen lds
	s_mov_b32 m0, s39
	v_readfirstlane_b32 s39, v188
	s_waitcnt lgkmcnt(0)
	buffer_load_dwordx4 v186, s[16:19], 0 offen lds
	...
	buffer_load_dwordx4 v185, s[16:19], 0 offen lds
	; sched_barrier mask(0x00000000)
	s_add_i32 s16, s40, 0x400
	v_add_u32_e32 v185, s37, v145
	v_add_u32_e32 v214, s37, v183
	v_add_u32_e32 v202, s40, v147
	v_add_u32_e32 v203, s40, v184
	v_add_u32_e32 v186, s36, v152
	v_add_u32_e32 v190, s36, v153
	v_add3_u32 v194, s38, v175, v149
	v_add3_u32 v198, s38, v176, v149
	v_add3_u32 v204, s38, v177, v149
	v_add3_u32 v206, s38, v178, v149
	v_add_u32_e32 v205, s16, v184
	ds_read_u8 v210, v214 offset:128
	ds_read_u8 v211, v185
	ds_read_u8 v212, v185 offset:32
	ds_read_u8 v213, v185 offset:96
	ds_read_u8 v215, v185 offset:160
	ds_read_u8 v216, v185 offset:224
	ds_read_u8 v185, v185 offset:1024
	ds_read_u8 v217, v202
	ds_read_b128 v[186:189], v186
	ds_read_b128 v[190:193], v190
	ds_read_b128 v[194:197], v194
	ds_read_b128 v[198:201], v198
	ds_read_u8 v218, v203 offset:64
	ds_read_u8 v219, v203 offset:128
	ds_read_u8 v220, v203 offset:192
	ds_read_u8 v221, v205 offset:64
	ds_read_u8 v222, v205 offset:128
	ds_read_u8 v223, v205 offset:192
	ds_read_u8 v224, v202 offset:1024
	ds_read_b128 v[202:205], v204
	ds_read_b128 v[206:209], v206
	s_waitcnt lgkmcnt(10)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[122:125], v[194:197], v[186:189], v[122:125], v217, v211 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_u8 v225, v214 offset:64
	s_addk_i32 s37, 0x400
	v_add_u32_e32 v226, s37, v183
	s_waitcnt lgkmcnt(9)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[126:129], v[198:201], v[186:189], v[126:129], v218, v211 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_add_u32 s4, s4, 0x80
	s_addc_u32 s5, s5, 0
	s_add_u32 s2, s2, 0x80
	s_waitcnt lgkmcnt(2)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[118:121], v[202:205], v[186:189], v[118:121], v219, v211 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_addc_u32 s3, s3, 0
	s_add_u32 s10, s10, s23
	s_addc_u32 s11, s11, s33
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[114:117], v[206:209], v[186:189], v[114:117], v220, v211 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v186, s36, v156
	v_add_u32_e32 v211, s36, v157
	s_add_u32 s8, s8, s22
	v_mfma_scale_f32_16x16x128_f8f6f4 v[110:113], v[194:197], v[190:193], v[110:113], v217, v212 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_addc_u32 s9, s9, s31
	s_add_i32 s34, s34, -1
	s_cmp_lg_u32 s34, 0
	v_mfma_scale_f32_16x16x128_f8f6f4 v[106:109], v[198:201], v[190:193], v[106:109], v218, v212 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[102:105], v[202:205], v[190:193], v[102:105], v219, v212 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[98:101], v[206:209], v[190:193], v[98:101], v220, v212 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[186:189], v186
	ds_read_b128 v[190:193], v211
	v_add_u32_e32 v211, s36, v159
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[94:97], v[194:197], v[186:189], v[94:97], v217, v225 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[90:93], v[198:201], v[186:189], v[90:93], v218, v225 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[86:89], v[202:205], v[186:189], v[86:89], v219, v225 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[82:85], v[206:209], v[186:189], v[82:85], v220, v225 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v186, s36, v158
	v_add_u32_e32 v225, s37, v145
	s_waitcnt lgkmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[78:81], v[194:197], v[190:193], v[78:81], v217, v213 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[74:77], v[198:201], v[190:193], v[74:77], v218, v213 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[70:73], v[202:205], v[190:193], v[70:73], v219, v213 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[66:69], v[206:209], v[190:193], v[66:69], v220, v213 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[186:189], v186
	ds_read_b128 v[190:193], v211
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[62:65], v[194:197], v[186:189], v[62:65], v217, v210 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[58:61], v[198:201], v[186:189], v[58:61], v218, v210 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[54:57], v[202:205], v[186:189], v[54:57], v219, v210 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[50:53], v[206:209], v[186:189], v[50:53], v220, v210 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v186, s36, v160
	v_add_u32_e32 v210, s36, v161
	ds_read_b128 v[186:189], v186
	ds_read_b128 v[210:213], v210
	ds_read_u8 v214, v214 offset:192
	s_waitcnt lgkmcnt(3)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[46:49], v[194:197], v[190:193], v[46:49], v217, v215 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_u8 v227, v225 offset:32
	ds_read_u8 v228, v225 offset:96
	ds_read_u8 v229, v225 offset:160
	v_mfma_scale_f32_16x16x128_f8f6f4 v[42:45], v[198:201], v[190:193], v[42:45], v218, v215 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[38:41], v[202:205], v[190:193], v[38:41], v219, v215 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[34:37], v[206:209], v[190:193], v[34:37], v220, v215 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v190, s38, v180
	ds_read_u8 v215, v226 offset:128
	ds_read_u8 v230, v226 offset:192
	ds_read_u8 v225, v225 offset:224
	s_waitcnt lgkmcnt(6)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[30:33], v[194:197], v[186:189], v[30:33], v217, v214 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[26:29], v[198:201], v[186:189], v[26:29], v218, v214 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[22:25], v[202:205], v[186:189], v[22:25], v219, v214 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[18:21], v[206:209], v[186:189], v[18:21], v220, v214 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v186, s38, v179
	v_add_u32_e32 v214, s36, v168
	ds_read_b128 v[186:189], v186
	ds_read_b128 v[190:193], v190
	v_mfma_scale_f32_16x16x128_f8f6f4 v[10:13], v[194:197], v[210:213], v[10:13], v217, v216 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v194, s36, v167
	v_add_u32_e32 v217, s38, v181
	v_mfma_scale_f32_16x16x128_f8f6f4 v[14:17], v[198:201], v[210:213], v[14:17], v218, v216 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v218, s38, v182
	ds_read_b128 v[194:197], v194
	ds_read_b128 v[198:201], v214
	v_mfma_scale_f32_16x16x128_f8f6f4 v[6:9], v[202:205], v[210:213], v[6:9], v219, v216 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[202:205], v217
	v_mfma_scale_f32_16x16x128_f8f6f4 v[2:5], v[206:209], v[210:213], v[2:5], v220, v216 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[206:209], v218
	v_add_u32_e32 v210, s36, v170
	s_waitcnt lgkmcnt(3)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[122:125], v[186:189], v[194:197], v[122:125], v224, v185 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[126:129], v[190:193], v[194:197], v[126:129], v221, v185 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[118:121], v[202:205], v[194:197], v[118:121], v222, v185 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[114:117], v[206:209], v[194:197], v[114:117], v223, v185 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v185, s36, v169
	ds_read_b128 v[194:197], v185
	ds_read_b128 v[210:213], v210
	ds_read_u8 v185, v226 offset:64
	v_mfma_scale_f32_16x16x128_f8f6f4 v[110:113], v[186:189], v[198:201], v[110:113], v224, v227 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[106:109], v[190:193], v[198:201], v[106:109], v221, v227 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[102:105], v[202:205], v[198:201], v[102:105], v222, v227 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[98:101], v[206:209], v[198:201], v[98:101], v223, v227 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v198, s36, v172
	s_waitcnt lgkmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[94:97], v[186:189], v[194:197], v[94:97], v224, v185 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[90:93], v[190:193], v[194:197], v[90:93], v221, v185 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[86:89], v[202:205], v[194:197], v[86:89], v222, v185 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[82:85], v[206:209], v[194:197], v[82:85], v223, v185 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v185, s36, v171
	ds_read_b128 v[194:197], v185
	ds_read_b128 v[198:201], v198
	v_add_u32_e32 v185, s36, v173
	v_mfma_scale_f32_16x16x128_f8f6f4 v[78:81], v[186:189], v[210:213], v[78:81], v224, v228 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[74:77], v[190:193], v[210:213], v[74:77], v221, v228 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[70:73], v[202:205], v[210:213], v[70:73], v222, v228 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[66:69], v[206:209], v[210:213], v[66:69], v223, v228 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v210, s36, v174
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[62:65], v[186:189], v[194:197], v[62:65], v224, v215 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[58:61], v[190:193], v[194:197], v[58:61], v221, v215 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[54:57], v[202:205], v[194:197], v[54:57], v222, v215 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[50:53], v[206:209], v[194:197], v[50:53], v223, v215 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[46:49], v[186:189], v[198:201], v[46:49], v224, v229 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[42:45], v[190:193], v[198:201], v[42:45], v221, v229 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[38:41], v[202:205], v[198:201], v[38:41], v222, v229 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[34:37], v[206:209], v[198:201], v[34:37], v223, v229 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[194:197], v185
	ds_read_b128 v[198:201], v210
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[30:33], v[186:189], v[194:197], v[30:33], v224, v230 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[26:29], v[190:193], v[194:197], v[26:29], v221, v230 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[22:25], v[202:205], v[194:197], v[22:25], v222, v230 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[18:21], v[206:209], v[194:197], v[18:21], v223, v230 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[10:13], v[186:189], v[198:201], v[10:13], v224, v225 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[14:17], v[190:193], v[198:201], v[14:17], v221, v225 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[6:9], v[202:205], v[198:201], v[6:9], v222, v225 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[2:5], v[206:209], v[198:201], v[2:5], v223, v225 op_sel_hi:[0,0,0] cbsz:4 blgp:4
...
.LBB0_7:
	...
	v_add_u32_e32 v158, s15, v138
	v_add_u32_e32 v156, s15, v0
	...
	v_add3_u32 v138, s27, v141, v176
	v_add3_u32 v182, s14, v1, v176
	v_add3_u32 v185, s27, v147, v176
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 v[18:21], v[154:157], v[170:173], v[18:21], v191, v183 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_or_b32_e32 v170, 0xe0, v1
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 v[18:21], v[158:161], v[174:177], v[18:21], v185, v162 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[172:175], v0
	ds_read_u8 v0, v182 offset:1248
	v_add_u32_e32 v162, v179, v166
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[10:13], v[134:137], v[172:175], v[10:13], v181, v165 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[134:137], v162
	v_mfma_scale_f32_16x16x128_f8f6f4 v[14:17], v[142:145], v[172:175], v[14:17], v186, v165 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[6:9], v[150:153], v[172:175], v[6:9], v189, v165 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[2:5], v[154:157], v[172:175], v[2:5], v191, v165 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 v[10:13], v[130:133], v[134:137], v[10:13], v180, v0 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[14:17], v[138:141], v[134:137], v[14:17], v187, v0 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 v[6:9], v[146:149], v[134:137], v[6:9], v188, v0 op_sel_hi:[0,0,0] cbsz:4 blgp:4
...
.LBB0_8:
	...
	v_add_lshl_u32 v18, v164, v155, 1
	s_and_b64 s[8:9], s[8:9], s[0:1]
	v_cvt_pk_bf16_f32 v1, v20, v21
	v_cndmask_b32_e64 v18, v123, v18, s[8:9]
	buffer_store_dwordx2 v[0:1], v18, s[24:27], 0 offen
	v_cvt_pk_bf16_f32 v0, v10, v11
	v_add_lshl_u32 v10, v165, v154, 1
	s_and_b64 s[6:7], vcc, s[6:7]
	v_cvt_pk_bf16_f32 v1, v12, v13
	v_cndmask_b32_e64 v10, v123, v10, s[6:7]
	buffer_store_dwordx2 v[0:1], v10, s[24:27], 0 offen
	v_add_lshl_u32 v10, v165, v157, 1
	s_and_b64 s[4:5], vcc, s[4:5]
	v_cvt_pk_bf16_f32 v1, v16, v17
	v_cvt_pk_bf16_f32 v0, v14, v15
	v_cndmask_b32_e64 v10, v123, v10, s[4:5]
	buffer_store_dwordx2 v[0:1], v10, s[24:27], 0 offen
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set _gemm_afp4_wfp4_kernel.num_vgpr, 231
