...
from aiter import pertoken_quant, get_hip_quant, get_triton_quant, get_torch_quant
...
def ck_moe_2stages(
    ...
    a1_scale = moe_mxfp4_sort(a1_scale, sorted_ids, num_valid_ids, M, block_size)
    ...
    a2_scale = moe_mxfp4_sort(a2_scale, sorted_ids, num_valid_ids, M, block_size)
