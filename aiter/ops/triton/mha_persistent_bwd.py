...
@triton.jit
def _persistent_bwd_kernel_dkdvdq_causal(
    q_ptr,
    k_ptr,
    v_ptr,
    sm_scale,
    ...
    while wid < TOTAL_NUM_WIDS:
        ...
        wid = tl.atomic_add(wid_counter, 1, sem="relaxed")


def _flash_attn_persistent_backward(
    do: torch.Tensor,
    q: torch.Tensor,
    k: torch.Tensor,
    v: torch.Tensor,
    ...
    _persistent_bwd_kernel_dkdvdq_causal[grid_dkdvdq](
        q,
        k,
        v,
        sm_scale,
