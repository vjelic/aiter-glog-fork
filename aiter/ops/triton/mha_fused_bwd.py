...
def _bwd_kernel_dkdvdq_causal(
    ...
    tl.assume(stride_q_b_in >= 0)
    tl.assume(stride_q_h_in >= 0)
    tl.assume(stride_q_m_in >= 0)
    tl.assume(stride_q_k_in >= 0)
    tl.assume(stride_k_b_in >= 0)
    tl.assume(stride_k_h_in >= 0)
    tl.assume(stride_k_n_in >= 0)
    tl.assume(stride_k_k_in >= 0)
    tl.assume(stride_v_b_in >= 0)
    tl.assume(stride_v_h_in >= 0)
    tl.assume(stride_v_n_in >= 0)
    tl.assume(stride_v_k_in >= 0)
    tl.assume(stride_dk_b_in >= 0)
    tl.assume(stride_dk_h_in >= 0)
    tl.assume(stride_dk_n_in >= 0)
    tl.assume(stride_dk_k_in >= 0)
    tl.assume(stride_dq_b_in >= 0)
    tl.assume(stride_dq_h_in >= 0)
    tl.assume(stride_dq_m_in >= 0)
    tl.assume(stride_dq_k_in >= 0)
    tl.assume(stride_delta_b_in >= 0)
    tl.assume(stride_delta_h_in >= 0)
    tl.assume(stride_delta_m_in >= 0)
    tl.assume(stride_do_b_in >= 0)
    tl.assume(stride_do_h_in >= 0)
    tl.assume(stride_do_m_in >= 0)
    tl.assume(stride_do_k_in >= 0)
...
def flash_attn_fused_backward(
    ...
    USE_INT64_STRIDES: tl.constexpr = False,
):
