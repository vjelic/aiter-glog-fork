...
@compile_ops("module_mla", fc_name="mla")
def mla(
    query: torch.Tensor,
...
@compile_ops("module_mla", fc_name="plan")
def plan(
    ...
    head_dim_o: int,
    causal: bool,
    cuda_stream: int) -> torch.Tensor: ...

@compile_ops("module_mla", fc_name="run")
def run(
    float_workspace_buffer: torch.Tensor,
    int_workspace_buffer: torch.Tensor,
