...
using DeviceGemmHelperF8BlockScale = ck::tensor_operation::device::DeviceGemmMultiD_BlockScale_Xdl_CShuffle_V3_BPreshuffle
    // clang-format off
...
__forceinline__ torch::Tensor gemm_a8w8_blockscale_wpreshuffle_impl(
    torch::Tensor &XQ,
    torch::Tensor &WQ,
