...
import argparse
import shutil
from gemm_a8w8_blockscale_wpreshuffle_common import kernelInstance, kernels_list, default_kernels_dict


""" 

a8w8_blockscale_wpreshuffle_gemm instance gen 

"""


class gemm_a8w8_blockscale_wpreshuffle_codegen:
...
"""     
        ...
        // Run kernel instance.
        return gemm_a8w8_blockscale_wpreshuffle_impl<DDataType, EDataType, DeviceGemmInstance>(XQ, WQ, x_scale, w_scale, Y);
""" 
        if self.istune:
...
#endif // USE_ROCM
"""
        with open(os.path.join(self.working_path, "gemm_a8w8_blockscale_wpreshuffle_lookup.h"), "w") as f:
            f.write(LOOKUP_head)
...
"""
        ...
        with open(os.path.join(self.working_path, "gemm_a8w8_blockscale_wpreshuffle_manifest.h"), "w") as f:
...
if __name__ == "__main__":
    ...
    codegen = gemm_a8w8_blockscale_wpreshuffle_codegen(args.working_path, args.tune)
