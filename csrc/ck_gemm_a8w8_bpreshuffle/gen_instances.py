...
import argparse
import shutil
from gemm_a8w8_bpreshuffle_common import kernelInstance, kernels_list, default_kernels_dict
...
#endif // USE_ROCM
"""
        with open(os.path.join(self.working_path, "gemm_a8w8_bpreshuffle_lookup.h"), "w") as f:
            f.write(LOOKUP_head)
...
"""
        ...
        with open(os.path.join(self.working_path, "gemm_a8w8_bpreshuffle_manifest.h"), "w") as f:
