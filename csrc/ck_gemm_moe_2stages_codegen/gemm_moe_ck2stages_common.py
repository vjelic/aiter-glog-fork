...
#   id: kernel:             BLOCK_SIZE| MPerBLOCK| NPerBLOCK| KPerBLOCK| MWaves| NWaves|GemmPipelineVersion
     ...
     5: kernelInstanceGEMM1(       256,        64,       128,       64,     1,       4,        3,),
...
# gemm2 out&AB:bf16/fp16
     0: kernelInstanceGEMM2(       256,        32,       128,        64,     1,       4,         1,),
     1: kernelInstanceGEMM2(       256,        64,       128,        64,     1,       4,         1,),
...
#   id: kernel:             BLOCK_SIZE| MPerBLOCK| NPerBLOCK| KPerBLOCK| MWaves| NWaves|GemmPipelineVersion
# gemm2 out&AB:bf16/fp16
     0: kernelInstanceGEMM2(       256,        32,        64,        64,     1,       4,         1,),
     1: kernelInstanceGEMM2(       256,        64,        64,        64,     1,       4,         1,),
