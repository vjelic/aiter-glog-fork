...
kernels_list_942 = {
    ...
    22: kernelInstance( 0, 0, 8, 4, 1, 0, 0, 0, 0, 1,   48,    64,   256,  1,  4,  1,   16,    16,    64, "Default"),
    23: kernelInstance( 0, 0, 8, 4, 1, 0, 0, 0, 0, 1,   64,    64,   256,  1,  4,  1,   16,    16,    64, "Default"),
    24: kernelInstance( 0, 0, 8, 4, 1, 0, 0, 0, 0, 1,   80,    64,   256,  1,  4,  1,   16,    16,    64, "Default"),  
    25: kernelInstance( 0, 0, 8, 4, 1, 0, 0, 0, 0, 1,   32,   128,   256,  1,  4,  1,   16,    16,    64, "Default"),
    26: kernelInstance( 0, 0, 8, 4, 1, 0, 0, 0, 0, 1,   48,   128,   256,  1,  4,  1,   16,    16,    64, "Default"),
    27: kernelInstance( 0, 0, 8, 4, 1, 0, 0, 0, 0, 1,   64,   128,   256,  1,  4,  1,   16,    16,    64, "Default"),
    28: kernelInstance( 0, 0, 8, 4, 1, 0, 0, 0, 0, 1,   80,   128,   256,  1,  4,  1,   16,    16,    64, "Default"), 
}
# '''
