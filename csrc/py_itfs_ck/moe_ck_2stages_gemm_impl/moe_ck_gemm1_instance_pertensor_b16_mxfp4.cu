...
CK_MOE_STAGE1_GEMM_MXFP4_DEFINE(64, 64/sizeof(A0DataType), 2, 2, V1, true, 0);
CK_MOE_STAGE1_GEMM_MXFP4_DEFINE(128, 64/sizeof(A0DataType), 2, 2, V1, true, 0);
...
CK_MOE_STAGE1_GEMM_MXFP4_DEFINE(64, 64/sizeof(A0DataType), 2, 2, V1, false, 0);
CK_MOE_STAGE1_GEMM_MXFP4_DEFINE(128, 64/sizeof(A0DataType), 2, 2, V1, false, 0);
...
CK_MOE_STAGE1_GEMM_MXFP4_DEFINE(64, 64/sizeof(A0DataType), 2, 2, V1, true, 1);
CK_MOE_STAGE1_GEMM_MXFP4_DEFINE(128, 64/sizeof(A0DataType), 2, 2, V1, true, 1);
...
CK_MOE_STAGE1_GEMM_MXFP4_DEFINE(64, 64/sizeof(A0DataType), 2, 2, V1, false, 1);
CK_MOE_STAGE1_GEMM_MXFP4_DEFINE(128, 64/sizeof(A0DataType), 2, 2, V1, false, 1);
...
CK_MOE_STAGE1_GEMM_MXFP4_DEFINE(64,  64/sizeof(A0DataType), 2, 2, V3, true, 0);
CK_MOE_STAGE1_GEMM_MXFP4_DEFINE(64,  64/sizeof(A0DataType), 2, 2, V3, false, 0);
CK_MOE_STAGE1_GEMM_MXFP4_DEFINE(64,  64/sizeof(A0DataType), 2, 2, V3, true, 1);
CK_MOE_STAGE1_GEMM_MXFP4_DEFINE(64,  64/sizeof(A0DataType), 2, 2, V3, false, 1);
CK_MOE_STAGE1_GEMM_MXFP4_DEFINE(128, 64/sizeof(A0DataType), 2, 2, V3, true, 0);
CK_MOE_STAGE1_GEMM_MXFP4_DEFINE(128, 64/sizeof(A0DataType), 2, 2, V3, false, 0);
CK_MOE_STAGE1_GEMM_MXFP4_DEFINE(128, 64/sizeof(A0DataType), 2, 2, V3, true, 1);
CK_MOE_STAGE1_GEMM_MXFP4_DEFINE(128, 64/sizeof(A0DataType), 2, 2, V3, false, 1);
