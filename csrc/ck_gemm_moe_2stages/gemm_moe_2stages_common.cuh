...
#define CK_MOE_STAGE1_GEMM_DEFINE(BLOCKSIZE, MPerBlock, NPerBlock, KPerBlock, MWaves, NWaves, MNPerXDL)                                                                                          \
    template void moe_stage1_gemm<A0DataType, B0DataType, AccDataType, EDataType, CDEElementOp, BLOCKSIZE, MPerBlock, NPerBlock, KPerBlock, MWaves, NWaves, MNPerXDL, Nswizzle, PerTensorQuant>( \
...
#define CK_MOE_STAGE2_GEMM_DEFINE(BLOCKSIZE, MPerBlock, NPerBlock, KPerBlock, MWaves, NWaves, MNPerXDL)                                                                                             \
    template void moe_stage2_gemm<A0DataType, B0DataType, AccDataType, EDataType, CDEElementOp, BLOCKSIZE, MPerBlock, NPerBlock, KPerBlock, MWaves, NWaves, MNPerXDL, Nswizzle, PerTensorQuant>( \
        const hipStream_t &stream,                                                                                                                                   \
        int tokens, int sorted_size, int N, int K,                                                                                                                   \
        int topk,                                                                                                                                                    \
        void *&inter_states,                                                                                                                                         \
