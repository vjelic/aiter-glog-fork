...
.LBB0_0:
	...
	v_and_b32_e32 v12, 0xfe0, v15
	v_and_b32_e32 v58, 0x70, v15
	s_mov_b32 s1, 0
	...
	v_add_u32_e32 v13, v4, v12
	buffer_load_dwordx4 v[8:11], v13, s[8:11], 0 offen
	v_add_u32_e32 v6, 0x1000, v13
	buffer_load_dwordx4 v[22:25], v6, s[8:11], 0 offen
	...
	buffer_load_dwordx4 v[26:29], v16, s[8:11], 0 offen
	buffer_load_dwordx4 v[30:33], v13, s[8:11], 0 offen
	v_cvt_f32_u32_e32 v16, s17
	v_sub_u32_e32 v6, v6, v14
	v_subrev_u32_e32 v14, s0, v6
	...
	v_mad_u32_u24 v13, v18, s8, v13
	v_bitop3_b32 v21, v15, 16, v6 bitop3:0x48
	s_add_i32 s15, 0, 0x20000
	v_add_u32_e32 v46, 0x1a0000, v13
	buffer_load_dwordx4 v[34:37], v13, s[20:23], 0 offen
	v_add_u32_e32 v47, 0x340000, v13
	buffer_load_dwordx4 v[38:41], v46, s[20:23], 0 offen
	buffer_load_dwordx4 v[42:45], v47, s[20:23], 0 offen
	v_add3_u32 v12, s15, v21, v12
	v_add_u32_e32 v21, 0x4e0000, v13
	buffer_load_dwordx4 v[46:49], v21, s[20:23], 0 offen
	v_add_u32_e32 v21, 0x680000, v13
	v_add_u32_e32 v59, 0x820000, v13
	buffer_load_dwordx4 v[50:53], v21, s[20:23], 0 offen
	buffer_load_dwordx4 v[54:57], v59, s[20:23], 0 offen
	v_or_b32_e32 v17, s0, v1
	v_add_u32_e32 v17, s18, v17
	v_xor_b32_e32 v21, s18, v17
	...
	s_waitcnt vmcnt(8)
	ds_write_b128 v12, v[30:33] offset:12288
	v_cndmask_b32_e32 v59, v26, v27, vcc
	v_add_u32_e32 v26, 48, v17
	v_xor_b32_e32 v26, s18, v26
	v_mul_hi_u32 v27, v26, v16
	v_mul_lo_u32 v27, v27, s17
	v_sub_u32_e32 v26, v26, v27
	v_subrev_u32_e32 v27, s17, v26
	v_cmp_le_u32_e32 vcc, s17, v26
	v_add_u32_e32 v12, 0xd00000, v13
	v_subrev_u32_e32 v62, s16, v14
	v_cndmask_b32_e32 v26, v26, v27, vcc
	v_subrev_u32_e32 v27, s17, v26
	v_cmp_le_u32_e32 vcc, s17, v26
	v_add_u32_e32 v14, 0xea0000, v13
	v_add_u32_e32 v64, 0x1040000, v13
	v_cndmask_b32_e32 v60, v26, v27, vcc
	v_lshlrev_b32_e32 v26, 1, v0
	v_bitop3_b32 v26, v15, s8, v26 bitop3:0x48
	v_add3_u32 v18, 0, v26, v18
	v_add_u32_e32 v65, 0x11e0000, v13
	v_add_u32_e32 v66, 0x1380000, v13
	v_add_u32_e32 v67, 0x1520000, v13
	v_add_u32_e32 v68, 0x16c0000, v13
	v_add_u32_e32 v13, 0x1860000, v13
	v_xor_b32_e32 v3, s16, v3
	v_subrev_u32_e32 v63, s16, v3
	s_waitcnt vmcnt(7)
	ds_write_b128 v18, v[34:37]
	s_waitcnt vmcnt(6)
	ds_write_b128 v18, v[38:41] offset:4096
	s_waitcnt vmcnt(5)
	ds_write_b128 v18, v[42:45] offset:8192
	buffer_load_dwordx4 v[26:29], v12, s[20:23], 0 offen
	buffer_load_dwordx4 v[30:33], v14, s[20:23], 0 offen
	v_add_u32_e32 v3, 64, v17
	s_waitcnt vmcnt(6)
	ds_write_b128 v18, v[46:49] offset:12288
	buffer_load_dwordx4 v[34:37], v64, s[20:23], 0 offen
	buffer_load_dwordx4 v[38:41], v65, s[20:23], 0 offen
	s_waitcnt vmcnt(7)
	ds_write_b128 v18, v[50:53] offset:16384
	s_waitcnt vmcnt(6)
	ds_write_b128 v18, v[54:57] offset:20480
	buffer_load_dwordx4 v[42:45], v66, s[20:23], 0 offen
	buffer_load_dwordx4 v[46:49], v67, s[20:23], 0 offen
	v_xor_b32_e32 v5, s18, v5
	...
	v_and_b32_e32 v64, 48, v15
	s_movk_i32 s8, 0xf0
	s_waitcnt vmcnt(7)
	ds_write_b128 v18, v[8:11] offset:24576
	buffer_load_dwordx4 v[50:53], v68, s[20:23], 0 offen
	buffer_load_dwordx4 v[54:57], v13, s[20:23], 0 offen
	v_subrev_u32_e32 v9, s18, v5
	v_xor_b32_e32 v5, s18, v59
	v_mul_hi_u32 v8, v3, v16
	v_subrev_u32_e32 v10, s18, v5
	v_xor_b32_e32 v5, s18, v60
	v_mul_lo_u32 v8, v8, s17
	v_subrev_u32_e32 v11, s18, v5
	v_add_u32_e32 v5, 0x50, v17
	v_sub_u32_e32 v3, v3, v8
	v_xor_b32_e32 v5, s18, v5
	v_subrev_u32_e32 v8, s17, v3
	v_cmp_le_u32_e32 vcc, s17, v3
	v_mul_hi_u32 v12, v5, v16
	...
	v_cmp_le_u32_e32 vcc, s17, v5
	v_and_b32_e32 v21, 0xf0, v15
	v_lshl_or_b32 v12, v12, 13, v21
	v_cndmask_b32_e32 v5, v5, v13, vcc
	v_subrev_u32_e32 v13, s17, v5
	v_cmp_le_u32_e32 vcc, s17, v5
	s_waitcnt vmcnt(8)
	ds_write_b128 v18, v[22:25] offset:28672
	v_and_b32_e32 v59, 0x80, v15
	v_cndmask_b32_e32 v5, v5, v13, vcc
	v_xor_b32_e32 v5, s18, v5
	v_subrev_u32_e32 v13, s18, v5
	v_add_u32_e32 v5, 0x70, v17
	v_xor_b32_e32 v5, s18, v5
	v_mul_hi_u32 v14, v5, v16
	...
	s_waitcnt vmcnt(7)
	ds_write_b128 v18, v[26:29] offset:32768
	s_waitcnt vmcnt(6)
	ds_write_b128 v18, v[30:33] offset:36864
	s_waitcnt vmcnt(5)
	ds_write_b128 v18, v[34:37] offset:40960
	s_waitcnt vmcnt(4)
	ds_write_b128 v18, v[38:41] offset:45056
	s_waitcnt vmcnt(3)
	ds_write_b128 v18, v[42:45] offset:49152
	s_waitcnt vmcnt(2)
	ds_write_b128 v18, v[46:49] offset:53248
	s_waitcnt vmcnt(1)
	ds_write_b128 v18, v[50:53] offset:57344
	s_waitcnt vmcnt(0)
	ds_write_b128 v18, v[54:57] offset:61440
	...
	v_lshl_or_b32 v8, v9, 13, v21
	v_lshl_or_b32 v9, v10, 13, v21
	v_lshl_or_b32 v10, v11, 13, v21
	v_lshl_or_b32 v11, v3, 13, v21
	v_lshl_or_b32 v14, v14, 13, v21
	; sched_barrier mask(0x00000000)
	v_and_b32_e32 v34, 48, v0
	v_bitop3_b32 v3, v15, v34, s8 bitop3:0x6c
	v_and_b32_e32 v16, 0xc0, v0
	v_xor_b32_e32 v16, v3, v16
	v_sub_u32_e32 v22, v16, v21
	v_ashrrev_i16_e32 v22, 4, v22
	v_lshlrev_b32_e32 v17, 8, v1
	v_add_u32_sdwa v20, v20, sext(v22) dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
	v_mov_b32_e32 v23, 4
	v_or_b32_e32 v18, v21, v17
	s_add_i32 s16, 0, 0x24000
	v_lshlrev_b32_sdwa v26, v23, sext(v22) dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:WORD_0
	v_lshrrev_b64 v[22:23], v20, exec
	v_add_u32_e32 v24, s16, v18
	v_add_u32_e32 v27, v26, v21
	v_and_b32_e32 v20, 1, v22
	v_add_u32_e32 v25, 0x1000, v24
	v_lshl_add_u32 v21, v62, 13, v27
	...
	v_add_u32_e32 v24, 0x1000, v20
	v_add_u32_e32 v32, v5, v26
	v_readfirstlane_b32 s18, v20
	v_add_u32_e32 v25, 0x2000, v20
	v_add_u32_e32 v27, 0x3000, v20
	v_add_u32_e32 v28, 0x4000, v20
	v_add_u32_e32 v29, 0x5000, v20
	v_add_u32_e32 v30, 0x6000, v20
	v_add_u32_e32 v31, 0x7000, v20
	s_and_b32 s9, s5, 0xffff
	s_mov_b32 s8, s4
	v_cndmask_b32_e32 v32, v22, v32, vcc
	s_mov_b32 m0, s18
	v_add_u32_e32 v20, v8, v26
	v_readfirstlane_b32 s18, v24
	buffer_load_dwordx4 v32, s[8:11], 0 offen sc0 nt lds
	v_cndmask_b32_e32 v20, v22, v20, vcc
	s_mov_b32 m0, s18
	v_readfirstlane_b32 s18, v25
	buffer_load_dwordx4 v20, s[8:11], 0 offen sc0 nt lds
	v_add_u32_e32 v20, v9, v26
	v_cndmask_b32_e32 v20, v22, v20, vcc
	s_mov_b32 m0, s18
	v_readfirstlane_b32 s18, v27
	buffer_load_dwordx4 v20, s[8:11], 0 offen sc0 nt lds
	v_add_u32_e32 v20, v10, v26
	v_cndmask_b32_e32 v20, v22, v20, vcc
	s_mov_b32 m0, s18
	v_readfirstlane_b32 s18, v28
	buffer_load_dwordx4 v20, s[8:11], 0 offen sc0 nt lds
	v_add_u32_e32 v20, v11, v26
	v_cndmask_b32_e32 v20, v22, v20, vcc
	s_mov_b32 m0, s18
	v_readfirstlane_b32 s18, v29
	buffer_load_dwordx4 v20, s[8:11], 0 offen sc0 nt lds
	v_add_u32_e32 v20, v12, v26
	v_cndmask_b32_e32 v20, v22, v20, vcc
	s_mov_b32 m0, s18
	v_readfirstlane_b32 s18, v30
	buffer_load_dwordx4 v20, s[8:11], 0 offen sc0 nt lds
	v_add_u32_e32 v20, v13, v26
	v_cndmask_b32_e32 v20, v22, v20, vcc
	s_mov_b32 m0, s18
	v_readfirstlane_b32 s18, v31
	buffer_load_dwordx4 v20, s[8:11], 0 offen sc0 nt lds
	v_add_u32_e32 v20, v14, v26
	v_cndmask_b32_e32 v20, v22, v20, vcc
	s_mov_b32 m0, s18
	v_and_b32_e32 v26, 15, v0
	buffer_load_dwordx4 v20, s[8:11], 0 offen sc0 nt lds
	v_and_b32_e32 v30, 48, v19
	v_lshlrev_b32_e32 v28, 1, v7
	v_or_b32_e32 v7, 16, v26
	v_bitop3_b32 v29, v19, v7, 48 bitop3:0x6c
	v_bitop3_b32 v32, v28, v30, v7 bitop3:0xf6
	v_lshrrev_b32_e32 v7, 2, v0
	v_and_or_b32 v35, v7, 48, v26
	v_and_b32_e32 v19, 0x90, v19
	v_and_b32_e32 v20, 0x120, v61
	v_or_b32_e32 v22, v20, v19
	v_or_b32_e32 v24, 64, v35
	s_movk_i32 s8, 0x400
	v_bitop3_b32 v33, v22, s8, v24 bitop3:0xde
	v_bitop3_b32 v22, v64, v15, 64 bitop3:0x72
	v_bitop3_b32 v25, v22, v34, v59 bitop3:0x36
	v_or_b32_e32 v22, 0x80, v58
	s_add_u32 s4, s4, 0x100
	v_bitop3_b32 v27, v20, v35, v19 bitop3:0x36
	v_bitop3_b32 v19, v20, v24, v19 bitop3:0x36
	v_bitop3_b32 v24, v59, v22, v34 bitop3:0x36
	v_or_b32_e32 v22, 0xc0, v64
	v_and_or_b32 v15, v15, 64, v34
	s_addc_u32 s5, s5, 0
	v_bitop3_b32 v22, v15, v22, v59 bitop3:0x36
...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	v_add_u32_e32 v44, v35, v20
	v_add_u32_e32 v48, v36, v20
...
; %bb.2:
	...
	s_barrier
	ds_read_u8 v12, v5
	ds_read_u8 v13, v5 offset:128
	ds_read_u8 v14, v5 offset:256
	ds_read_u8 v5, v5 offset:384
	ds_read_u8 v66, v8
	ds_read_u8 v67, v8 offset:128
	ds_read_u8 v68, v8 offset:256
	ds_read_u8 v69, v8 offset:384
	v_and_b32_e32 v70, 16, v7
	v_and_b32_e32 v71, 32, v7
	v_add_u32_e32 v8, 0, v27
	v_or3_b32 v16, v70, v26, v71
	v_add_u32_e32 v9, 0, v19
	ds_read_u8 v72, v8 offset:63488
	ds_read_u8 v73, v8 offset:64064
	ds_read_u8 v74, v8 offset:64512
	ds_read_u8 v75, v8 offset:65088
	ds_read_u8 v76, v9 offset:63488
	v_xor_b32_e32 v8, 0xfe40, v19
	v_add_u32_e32 v8, 0, v8
	v_add_u32_e32 v17, s16, v3
	v_lshlrev_b32_e32 v16, 8, v16
	ds_read_u8 v77, v8
	ds_read_u8 v78, v9 offset:64512
	v_add_u32_e32 v8, v17, v20
	v_add_u32_e32 v18, s16, v25
	v_add3_u32 v3, s17, v3, v16
	v_add_u32_e32 v21, v18, v20
	ds_read_b128 v[8:11], v8
	ds_read_b128 v[26:29], v21
	ds_read_b128 v[30:33], v3
	v_add_u32_e32 v79, s16, v24
	v_add3_u32 v23, s17, v25, v16
	ds_read_b128 v[34:37], v23
	v_add_u32_e32 v80, s16, v22
	v_add3_u32 v24, s17, v24, v16
	ds_read_b128 v[38:41], v24
	ds_read_b128 v[42:45], v3 offset:16384
	v_add_u32_e32 v3, v80, v20
	v_add_u32_e32 v21, v79, v20
	ds_read_b128 v[46:49], v23 offset:16384
	ds_read_b128 v[50:53], v21
	ds_read_b128 v[54:57], v3
	v_add3_u32 v3, s17, v22, v16
	ds_read_b128 v[20:23], v24 offset:16384
	ds_read_b128 v[58:61], v3
	ds_read_b128 v[62:65], v3 offset:16384
	v_xor_b32_e32 v3, 0xfa40, v19
	v_add_u32_e32 v3, 0, v3
	ds_read_u8 v3, v3
	s_waitcnt lgkmcnt(10)
	v_mfma_scale_f32_16x16x128_f8f6f4 a[4:7], v[30:33], v[8:11], a[4:7], v72, v12 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_ashr_i32 s1, s13, 31
	s_mul_hi_i32 s2, s13, 0x1a000
	s_mul_i32 s13, s13, 0x1a000
	s_waitcnt lgkmcnt(7)
	v_mfma_scale_f32_16x16x128_f8f6f4 a[12:15], v[42:45], v[8:11], a[12:15], v76, v12 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v8, v17, v15
	ds_read_b128 v[8:11], v8 offset:4096
	v_lshlrev_b32_e32 v0, 7, v0
	v_mfma_scale_f32_16x16x128_f8f6f4 a[4:7], v[34:37], v[26:29], a[4:7], v73, v13 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mul_u32_u24_e32 v1, 0xd000, v1
	v_and_b32_e32 v0, 0x780, v0
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 a[12:15], v[46:49], v[26:29], a[12:15], v3, v13 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 a[4:7], v[38:41], v[50:53], a[4:7], v74, v14 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 a[12:15], v[20:23], v[50:53], a[12:15], v78, v14 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 a[4:7], v[58:61], v[54:57], a[4:7], v75, v5 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mfma_scale_f32_16x16x128_f8f6f4 a[12:15], v[62:65], v[54:57], a[12:15], v77, v5 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v5, v18, v15
	ds_read_b128 v[16:19], v5 offset:4096
	v_add_u32_e32 v5, v79, v15
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 a[8:11], v[42:45], v[8:11], a[8:11], v76, v66 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[24:27], v5 offset:4096
	v_add_u32_e32 v5, v80, v15
	ds_read_b128 v[12:15], v5 offset:4096
	v_mfma_scale_f32_16x16x128_f8f6f4 a[0:3], v[30:33], v[8:11], a[0:3], v72, v66 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mov_b32_e32 v5, s1
	v_and_b32_e32 v10, 0x78, v6
	v_or_b32_e32 v8, s0, v10
	s_waitcnt lgkmcnt(2)
	v_mfma_scale_f32_16x16x128_f8f6f4 a[8:11], v[46:49], v[16:19], a[8:11], v3, v67 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mov_b32_e32 v3, s1
	s_ashr_i32 s1, s0, 31
	s_add_u32 s3, s6, s13
	v_mfma_scale_f32_16x16x128_f8f6f4 a[0:3], v[34:37], v[16:19], a[0:3], v73, v67 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_mov_b32_e32 v9, s1
	s_addc_u32 s2, s7, s2
	...
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 a[0:3], v[38:41], v[24:27], a[0:3], v74, v68 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 a[8:11], v[20:23], v[24:27], a[8:11], v78, v68 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	...
	s_waitcnt lgkmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 a[0:3], v[58:61], v[12:15], a[0:3], v75, v69 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	...
	v_mfma_scale_f32_16x16x128_f8f6f4 a[8:11], v[62:65], v[12:15], a[8:11], v77, v69 op_sel_hi:[0,0,0] cbsz:4 blgp:4
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set _gemm_afp4_wfp4_kernel.num_vgpr, 81
