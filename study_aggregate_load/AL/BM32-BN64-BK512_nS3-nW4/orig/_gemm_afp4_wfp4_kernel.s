...
.LBB0_1:                                ; =>This Inner Loop Header: Depth=1
	...
	s_and_b32 s9, s18, 0x200
	s_and_b32 s16, s18, 0x400
	s_and_b32 s17, s18, 0x800
	s_and_b32 s26, s18, 0x1000
	v_or_b32_e32 v29, s9, v27
	s_cmp_lt_u32 s23, 16
	v_or_b32_e32 v30, s9, v28
	v_or_b32_e32 v29, s16, v29
	s_cselect_b32 s27, 0, 0x2000
	s_cselect_b32 s28, 0, 0x4000
	s_and_b32 s29, s18, 0x1800
	s_and_b32 s33, s21, 0x1000
	s_lshl_b32 s35, s22, 13
	s_lshl_b32 s36, s22, 14
	v_or_b32_e32 v31, s16, v30
	s_and_b32 s31, s21, 0x3000
	v_or_b32_e32 v32, s17, v29
	v_or_b32_e32 v30, s29, v30
	v_or_b32_e32 v33, s33, v26
	s_add_i32 s33, s35, 0
	s_add_i32 s17, s36, 0
	s_and_b32 s30, s21, 0xc00
	s_and_b32 s34, s21, 0x2000
	s_or_b32 s26, s27, s26
	s_or_b32 s37, s29, s27
	s_add_i32 s29, s31, 0
	v_or_b32_e32 v30, s16, v30
	s_add_i32 s16, s33, 0x14000
	v_add3_u32 v34, s17, v11, v12
	v_add_u32_e32 v35, s17, v13
	s_or_b32 s31, s28, s34
	v_or_b32_e32 v32, s26, v32
	v_or_b32_e32 v29, s37, v29
	v_or_b32_e32 v31, s37, v31
	s_add_i32 s29, s29, s30
	v_or_b32_e32 v33, s30, v33
	v_or_b32_e32 v30, s27, v30
	v_add_u32_e32 v36, s16, v13
	v_add_u32_e32 v37, 0x1000, v35
	v_sub_u32_e32 v40, v34, v35
	v_add_u32_e32 v32, s13, v32
	v_add_u32_e32 v29, s13, v29
	v_add_u32_e32 v31, s13, v31
	s_add_i32 s28, s28, s29
	v_or_b32_e32 v33, s31, v33
	v_add_u32_e32 v38, 0x2000, v35
	v_add_u32_e32 v39, 0x3000, v35
	v_add_u32_e32 v30, s13, v30
	v_add_u32_e32 v41, 0x1000, v36
	v_readfirstlane_b32 s27, v36
	v_ashrrev_i32_e32 v36, 31, v40
	v_sub_u32_e32 v42, v34, v37
	s_waitcnt vmcnt(6) lgkmcnt(0)
	s_barrier
	v_readfirstlane_b32 s26, v35
	v_add_u32_e32 v35, s28, v26
	v_add_u32_e32 v33, s20, v33
	v_readfirstlane_b32 s28, v37
	v_sub_u32_e32 v37, v34, v38
	v_sub_u32_e32 v34, v34, v39
	s_waitcnt vmcnt(0)
	ds_read_u8 v46, v32
	ds_read_u8 v50, v29 offset:128
	ds_read_u8 v51, v29 offset:256
	ds_read_u8 v29, v29 offset:384
	ds_read_u8 v52, v31
	ds_read_u8 v53, v30 offset:128
	ds_read_u8 v54, v30 offset:256
	ds_read_u8 v55, v30 offset:384
	ds_read_u8 v56, v35 offset:49152
	ds_read_u8 v57, v33 offset:256
	ds_read_u8 v58, v33 offset:512
	ds_read_u8 v59, v33 offset:768
	v_lshrrev_b32_e32 v30, 28, v36
	v_add_u32_e32 v31, 0x1000, v42
	s_mov_b32 s8, s19
	s_and_b32 s9, s3, 0xffff
	v_readfirstlane_b32 s31, v41
	v_add_u32_e32 v32, 0x2000, v37
	v_add_u32_e32 v33, 0x3000, v34
	s_mov_b32 m0, s27
	...
	v_add_u32_e32 v31, v31, v9
	buffer_load_dwordx4 v30, s[8:11], 0 offen sc0 nt lds
	s_mov_b32 m0, s29
	v_add_u32_e32 v32, v32, v10
	buffer_load_dwordx4 v31, s[8:11], 0 offen sc0 nt lds
	s_mov_b32 m0, s30
	v_add3_u32 v30, s24, v6, v25
	buffer_load_dwordx4 v32, s[8:11], 0 offen sc0 nt lds
	ds_read_b128 v[30:33], v30
	v_add_u32_e32 v34, s25, v6
	v_add_u32_e32 v35, s25, v23
	v_add3_u32 v36, s24, v23, v25
	v_add_u32_e32 v38, v34, v24
	v_add_u32_e32 v42, v35, v24
	v_add_u32_e32 v47, v34, v22
	v_add_u32_e32 v48, v35, v22
	ds_read_b128 v[34:37], v36
	ds_read_b128 v[38:41], v38
	ds_read_b128 v[42:45], v42
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 a[4:7], v[30:33], v[38:41], a[4:7], v56, v46 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[38:41], v47 offset:4096
	ds_read_b128 v[46:49], v48 offset:4096
	v_add3_u32 v62, s24, v21, v25
	v_add_u32_e32 v60, s25, v21
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 a[0:3], v[30:33], v[38:41], a[0:3], v56, v52 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[30:33], v62
	v_add_u32_e32 v61, s25, v20
	v_add3_u32 v63, s24, v20, v25
	ds_read_b128 v[38:41], v63
	v_add_u32_e32 v52, v60, v24
	v_add_u32_e32 v56, v61, v24
	v_mfma_scale_f32_16x16x128_f8f6f4 a[4:7], v[34:37], v[42:45], a[4:7], v57, v50 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	v_add_u32_e32 v60, v60, v22
	v_add_u32_e32 v50, v61, v22
	s_add_i32 s23, s23, 1
	s_waitcnt lgkmcnt(2)
	v_mfma_scale_f32_16x16x128_f8f6f4 a[0:3], v[34:37], v[46:49], a[0:3], v57, v53 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[34:37], v52
	ds_read_b128 v[42:45], v56
	s_add_u32 s4, s4, 0x100
	s_addc_u32 s5, s5, 0
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 a[4:7], v[30:33], v[34:37], a[4:7], v58, v51 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	ds_read_b128 v[34:37], v60 offset:4096
	ds_read_b128 v[46:49], v50 offset:4096
	s_add_u32 s19, s19, 0x100
	s_addc_u32 s3, s3, 0
	s_waitcnt lgkmcnt(1)
	v_mfma_scale_f32_16x16x128_f8f6f4 a[0:3], v[30:33], v[34:37], a[0:3], v58, v54 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_addk_i32 s21, 0x400
	s_addk_i32 s18, 0x200
	s_cmp_lg_u32 s23, 30
	v_mfma_scale_f32_16x16x128_f8f6f4 a[4:7], v[38:41], v[42:45], a[4:7], v59, v29 op_sel_hi:[0,0,0] cbsz:4 blgp:4
	s_waitcnt lgkmcnt(0)
	v_mfma_scale_f32_16x16x128_f8f6f4 a[0:3], v[38:41], v[46:49], a[0:3], v59, v55 op_sel_hi:[0,0,0] cbsz:4 blgp:4
...
; %bb.2:
	...
	v_add_u32_e32 v14, s16, v54
	v_add_u32_e32 v10, s17, v58
	ds_read_b128 v[10:13], v10
	ds_read_b128 v[14:17], v14
	v_add_u32_e32 v18, s16, v55
	ds_read_b128 v[18:21], v18
	v_add_u32_e32 v23, s17, v59
	s_waitcnt lgkmcnt(1)
...
.Lfunc_end0:
	...
	.cfi_endproc
                                        ; -- End function
	.set _gemm_afp4_wfp4_kernel.num_vgpr, 64
	.set _gemm_afp4_wfp4_kernel.num_agpr, 8
	.set _gemm_afp4_wfp4_kernel.numbered_sgpr, 38
